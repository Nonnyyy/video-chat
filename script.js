...
let config = {
    appid:'f1d53361e1304e1f8ffa7384998a4fe3',
    token:'007eJxTYLB9ePHmdCmjHR8DilcZcy46sNmyJtm3b+OKtRXhRWEO294qMKQZppgaG5sZphoaG5ikGqZZpKUlmhtbmFhaWiSapKUad7F3pTQEMjJ80ihnZmSAQBCfk8EnsyxVwTkjsYSBAQAqVyFY',
    uid:null,
    channel:'Live Chat',
}
...
document.getElementById('audio-btn').addEventListener('click', async () => {
    ...
    if(!localTrackState.audioTrackMuted){
        ...
        document.getElementById('audio-btn').style.backgroundColor ='rgb(255, 80, 80, 0.7)'
    }else{
